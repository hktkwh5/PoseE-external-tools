...
class MPII3D(Dataset3D):
    def __init__(self, set, seqlen,iris_training1=0,
            iris_training2=0,iris_training3=0, overlap=0, debug=False):
        db_name = 'mpii3d'
        ...
        folder=MPII3D_DIR,
        seqlen=seqlen,
        iris_training1=iris_training1,
        iris_training2=iris_training2,
        iris_training3=iris_training3,
        overlap=overlap,
