...
def get_data_loaders(cfg,iris_training1=0,iris_training2=0,iris_training3=0):
    def get_2d_datasets(dataset_names):
        datasets = []
        for dataset_name in dataset_names:
            db = eval(dataset_name)(set='train', seqlen=cfg.DATASET.SEQLEN,iris_training1=iris_training1,iris_training2=iris_training2,iris_training3=iris_training3, debug=cfg.DEBUG)
            datasets.append(db)
    ...
    motion_disc_db = MPII3D(set='val', seqlen=cfg.DATASET.SEQLEN,iris_training1=iris_training1,iris_training2=iris_training2,iris_training3=iris_training3, debug=cfg.DEBUG)
    ...
    # ===== Evaluation dataset =====
    valid_db = eval(cfg.TRAIN.DATASET_EVAL)(set='val', seqlen=cfg.DATASET.SEQLEN,iris_training1=iris_training1,iris_training2=iris_training2,iris_training3=iris_training3, debug=cfg.DEBUG)
...
def get_data_loaders_aa(cfg,test_db,iris_training1=0,iris_training2=0,iris_training3=0):
    # def get_2d_datasets(dataset_names):
    #     datasets = []
    #     for dataset_name in dataset_names:
    #         db = eval(dataset_name)(set='train', seqlen=cfg.DATASET.SEQLEN,iris_training1=iris_training1,iris_training2=iris_training2,iris_training3=iris_training3, debug=cfg.DEBUG)
