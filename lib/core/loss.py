...
class VIBELoss_cross_eye(nn.Module):
    def __init__(
            self,
            e_loss_weight=60.,
            e_3d_loss_weight=30.,
        ...
        super(VIBELoss_cross_eye, self).__init__()
        self.e_loss_weight = e_loss_weight
        self.e_3d_loss_weight = e_3d_loss_weight
        self.e_pose_loss_weight = e_pose_loss_weight
        self.e_shape_loss_weight = e_shape_loss_weight
    ...
    def forward(
        ...
        real_2d = reduce(real_2d)
        real_2d = torch.tensor(convert_kps(np.array(real_2d.cpu()), src='spin', dst='common')).cuda()
