...
VIBE_DB_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/vibe_db'
AMASS_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/amass'
INSTA_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/insta_variety'
MPII3D_DIR = 'G:\\document\\Time-space-map-and-point-cloud-map\\3D-action-estimate\\multiview-human-pose-estimation-pytorch-master\\data\\mpi-inf-3dhp\\images(256_256)'
THREEDPW_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/3dpw'
PENNACTION_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/penn_action'
POSETRACK_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/posetrack'
VIBE_DATA_DIR = 'I:\\diskF\\VIBE-master\\lib\\data/vibe_data'
...
cfg.TRAIN = CN()
cfg.TRAIN.DATASETS_2D = ['MPII3D']
cfg.TRAIN.DATASETS_3D = ['MPII3D']
cfg.TRAIN.DATASET_EVAL = 'MPII3D'
cfg.TRAIN.BATCH_SIZE = 36#cfg.TRAIN.BATCH_SIZE = 32
